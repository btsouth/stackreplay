  ...
  return (
    ...
    >
          ...
          >
            <div className="flex flex-wrap items-baseline justify-between gap-x-4 gap-y-1">
              <span className="flex min-w-0 flex-col">
                ...
                <span className="text-[11px] leading-snug text-muted-foreground">{row.note}</span>
              </span>
      ...
      <details className="group border-t border-border pt-3" data-testid="evidence-assumptions">
        <summary className="cursor-pointer list-none font-mono text-[10px] uppercase tracking-[0.18em] text-muted-foreground focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring">
        ...
        <ul className="mt-2 flex flex-col gap-1.5">
          {projection.assumptions.map((assumption) => (
            <li className="text-[11px] leading-relaxed text-muted-foreground" key={assumption}>
              {assumption}
            </li>
          ))}
        </ul>
